...
const sections = [
	{
		...
		title: (
			<>
				<span className="hidden lg:inline">Yozishga loyihalar</span>
				<span className="lg:hidden">Loyihalar</span>
			</>
		),
	},
	{ id: "resources", title: "Resurslar" },
	{ id: "communities", title: "Jamiyatlar" },
	{ id: "contributor", title: "Faol Rustacean" },
];
